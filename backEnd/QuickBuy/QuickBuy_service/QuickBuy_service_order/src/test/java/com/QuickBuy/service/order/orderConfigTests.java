...
//        mockMvc = MockMvcBuilders.standaloneSetup(new BrandController()).build();
    ...
    public void testfindAll() throws Exception {
        mockMvc.perform(get("/orderConfig"))
    ...
    public void testadd() throws Exception {
        mockMvc.perform(post("/orderConfig"))
                .andExpect(status().isOk())
                .andDo(print());
    }
    ...
    public void testupdate() throws Exception {
        mockMvc.perform(put("/orderConfig/000000"))
                .andExpect(status().isOk())
                .andDo(print());
    }
    ...
    public void testdelete() throws Exception {
        mockMvc.perform(delete("/orderConfig/000000"))
                .andExpect(status().isOk())
                .andDo(print());
    }
    ...
    public void testfindList() throws Exception {
        mockMvc.perform(get("/orderConfig/search"))
                .andExpect(status().isOk())
                .andDo(print());
    }
}
